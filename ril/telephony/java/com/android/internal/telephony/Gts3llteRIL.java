 ...
 * {@hide}
 */
public class Gts3llteRIL extends RIL implements CommandsInterface {

    public Gts3llteRIL(Context context, int preferredNetworkType, int cdmaSubscription) {
        this(context, preferredNetworkType, cdmaSubscription, null);
    }

    public Gts3llteRIL(Context context, int preferredNetworkType,
